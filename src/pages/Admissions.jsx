  ...
  return (
    <div>
      <Helmet>
        ...
        <meta name="description" content="Begin your journey at Divine Lifting International School. View admission requirements, fee structure, and step-by-step application process for all grade levels." />
      </Helmet>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-20">
              {requirementsData.map((req, idx) => (
                  ...
                  >
                      ...
                      <ul className="space-y-2">
                        {req.requirements.map((r, i) => (
                          <li key={i} className="flex items-start gap-2">
                            <CheckCircle
                              size={16}
                              className="text-[#fb923c] flex-shrink-0 mt-1"
                            />
                    ...
                    <Link
                      to="/apply"
                      className="block text-center bg-[#c2410c] hover:bg-[#9a3412] text-white font-bold py-2 rounded-lg transition-colors duration-300"
                    >
                      Apply Now
                    </Link>
                  </div>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {datesData.map((item, idx) => (
                ...
                >
                  <Calendar size={32} className="text-[#fb923c] flex-shrink-0" />
                  <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {statsData.map((item, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className="bg-gradient-to-br from-[#fbbf24] to-[#d97706] rounded-lg p-6 text-center shadow-md hover:-translate-y-1 transition-transform duration-300"
                    >
